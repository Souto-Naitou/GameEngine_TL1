...
OutlineOption* DepthBasedOutline::GetOption()
{
    return pOption_;
}
...
void DepthBasedOutline::CreateRootSignature()
{
    ...
    rootParameters[2].Descriptor.ShaderRegister = 1;                                    // シェーダーレジスタ番号
...
{
    optionResource_ = DX12Helper::CreateBufferResource(device_, sizeof(OutlineOption));
